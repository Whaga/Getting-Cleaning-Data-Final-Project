...
A complete description of the original data files used to create this dataset can be found at 
...
The first 2 variables identify the subject and activity
 ...
 [2] "Activity" - the name of the activity (WALKING, WALKING_UPSTAIRS,              WALKING_DOWNSTAIRS, SITTING, STANDING, LAYING)  
